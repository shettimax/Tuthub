...
$queryx =mysqli_query($conn,"SELECT id from account");
...
<div class="small text-white">all onboard</div>
</div>
...
<span class="mr-5">Unconfirmed Users</span>
<?php 
include_once 'config.php';
$queryxi =mysqli_query($conn,"SELECT id from account where paid='0'");
...
<div class="small text-white">unverified/pending pay</div>
</div>
...
<span class="mr-5">Confirmed Users</span>
<?php 
include_once 'config.php';
$queryxx =mysqli_query($conn,"SELECT id from account where paid='1'");
...
<div class="small text-white">total users verified</div>
</div>
...
<span class="mr-5">Tutors</span>
<?php 
include_once 'config.php';
$queryxxi =mysqli_query($conn,"SELECT id from tutors where paid=1");
...
<div class="small text-white">moderators adding lessons</div>
</div>
...
<span class="mr-5">TopCourses</span>
<?php 
include_once 'config.php';
$queryzx =mysqli_query($conn,"SELECT id from offers");
...
<?php
                                        ...
                                        $get="select name from offers limit 2";
