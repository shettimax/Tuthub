...
<div class="panel-body">
    ...
    <br>
     ...
     <?php echo $phone;?>
      ...
      <hr>
      <center>
        <a href="addlesson.php"><button type="reset" class="btn btn-default">ADD LESSON</button></a>&nbsp;&nbsp;
<a href="verify.php"><button type="submit" name="signup" class="btn btn-primary">VERIFY ID</button></center></a>
