...
if (isset($_POST['login']))
{
  $username = $_POST['email'];
    ...
    $query = "SELECT * FROM tutors WHERE email='$username' and password='$password'";
...
The purpose of this website, company, products, coaching and the educational services and information provided through and delivered via our blog, Website, Products, <br><font color="red"><b>NOT A TUTOR KINDLY</b><a href="log.php"> click here</a></p></font>
    <hr>
    -<b>LOGIN</b>-
    <br>
...
kindly <a href="prereg.php" title="get onboard">REGISTER</a></b>
</center>
  </nav>